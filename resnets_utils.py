...
def random_mini_batches(X, Y, mini_batch_size = 64):
    ...
    Arguments:
    X -- input data, of shape (number of examples, input size) (m, Hi, Wi, Ci)
    Y -- true "label" vector (containing 0 if cat, 1 if non-cat), of shape (number of examples, 1) (m, n_y)
